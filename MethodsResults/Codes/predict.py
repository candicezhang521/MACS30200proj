...
class ReviewCategoryClassifier(object):
	...
	def load_data(cls, input_file):
		...
		with open(input_file) as src:
			for line in src:
				#line should be the final output from category_predictor
...
if __name__ == "__main__":
	...
	best_guesses = sorted(guesses.items(), key=lambda prob: prob, reverse=True)[:5]
